...
public class FangjanCommentbackView extends FangjanCommentbackEntity implements Serializable {
	...
	public FangjanCommentbackView() {

	}

	public FangjanCommentbackView(FangjanCommentbackEntity fangjanCommentbackEntity) {
		try {
			BeanUtils.copyProperties(this, fangjanCommentbackEntity);
