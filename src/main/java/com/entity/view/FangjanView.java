 ...
 */
@TableName("fangjan")
public class FangjanView extends FangjanEntity implements Serializable {
	...
	public FangjanView(FangjanEntity fangjanEntity) {
		try {
			BeanUtils.copyProperties(this, fangjanEntity);
