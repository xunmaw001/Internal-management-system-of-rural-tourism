...
public class FangjanOrderView extends FangjanOrderEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 订单类型的值
		*/
		private String fangjanOrderValue;
	...
	public FangjanOrderView() {

	}

	public FangjanOrderView(FangjanOrderEntity fangjanOrderEntity) {
		try {
			BeanUtils.copyProperties(this, fangjanOrderEntity);
			...
			* 获取： 订单类型的值
			*/
			public String getFangjanOrderValue() {
				return fangjanOrderValue;
			}
			/**
			* 设置： 订单类型的值
			*/
			public void setFangjanOrderValue(String fangjanOrderValue) {
				this.fangjanOrderValue = fangjanOrderValue;
			}
