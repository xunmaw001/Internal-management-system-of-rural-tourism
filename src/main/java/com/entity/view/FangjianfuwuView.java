...
public class FangjianfuwuView extends FangjianfuwuEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 服务类型的值
		*/
		private String fangjianfuwuValue;
	...
	public FangjianfuwuView() {

	}

	public FangjianfuwuView(FangjianfuwuEntity fangjianfuwuEntity) {
		try {
			BeanUtils.copyProperties(this, fangjianfuwuEntity);
			...
			* 获取： 服务类型的值
			*/
			public String getFangjianfuwuValue() {
				return fangjianfuwuValue;
			}
			/**
			* 设置： 服务类型的值
			*/
			public void setFangjianfuwuValue(String fangjianfuwuValue) {
				this.fangjianfuwuValue = fangjianfuwuValue;
			}
