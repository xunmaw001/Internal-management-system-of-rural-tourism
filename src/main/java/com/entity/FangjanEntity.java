 ...
 */
@TableName("fangjan")
public class FangjanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public FangjanEntity() {

	}

	public FangjanEntity(T t) {
		try {
    ...
    public String toString() {
        return "Fangjan{" +
            ...
            ", fangjanName=" + fangjanName +
            ", fangjanTypes=" + fangjanTypes +
            ", fangjanPhoto=" + fangjanPhoto +
            ", fangjanOldMoney=" + fangjanOldMoney +
            ", fangjanNewMoney=" + fangjanNewMoney +
            ", shangxiaTypes=" + shangxiaTypes +
            ", fangjanDelete=" + fangjanDelete +
            ", fangjanContent=" + fangjanContent +
