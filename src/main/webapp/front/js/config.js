...
var centerMenu = [
    ...
    ,{
        name: '房间收藏',
        url: '../fangjanCollection/list.html'
    }
    ,{
        name: '房间订单',
        url: '../fangjanOrder/list.html'
    }
...
var adminurl =  "http://localhost:8080/nongjiale/admin/dist/index.html#/login";
