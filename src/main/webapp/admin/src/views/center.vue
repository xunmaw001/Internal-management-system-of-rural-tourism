  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='shangjia'"  label='农家乐地址' prop="shangjiaAddress">
               <el-input v-model="ruleForm.shangjiaAddress"  placeholder='农家乐地址' clearable></el-input>
           </el-form-item>
         </el-col>
