    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="农家乐地址" prop="shangjiaAddress">
                       <el-input v-model="ruleForm.shangjiaAddress"
                                 placeholder="农家乐地址" clearable  :readonly="ro.shangjiaAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="农家乐地址" prop="shangjiaAddress">
                           <el-input v-model="ruleForm.shangjiaAddress"
                                     placeholder="农家乐地址" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangjiaAddress: [
                              { required: true, message: '农家乐地址不能为空', trigger: 'blur' },
                          ],
                   shangjiaPhone: [
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangjiaAddress'){
                          this.ruleForm.shangjiaAddress = obj[o];
                          this.ro.shangjiaAddress = true;
                          continue;
                      }
                      if(o=='shangjiaPhone'){
